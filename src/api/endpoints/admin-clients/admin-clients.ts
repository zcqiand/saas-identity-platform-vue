...
export const adminClientsListClients = (
    params?: MaybeRef<AdminClientsListClientsParams>, options?: AxiosRequestConfig
...
export const getAdminClientsListClientsQueryKey = (params?: MaybeRef<AdminClientsListClientsParams>,) => {
    return [
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  getAdminClientsListClientsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminClientsListClients>>, TError, TData> 
}
...
export function useAdminClientsListClients<TData = Awaited<ReturnType<typeof adminClientsListClients>>, TError = AxiosError<ErrorResponse>>(
 params?: MaybeRef<AdminClientsListClientsParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof adminClientsListClients>>, TError, TData>>, axios?: AxiosRequestConfig}
...
export const adminClientsCreateClient = (
    createOAuthClientRequest: MaybeRef<CreateOAuthClientRequest>, options?: AxiosRequestConfig
...
export const getAdminClientsGetClientQueryOptions = <TData = Awaited<ReturnType<typeof adminClientsGetClient>>, TError = AxiosError<ErrorResponse>>(clientId: MaybeRef<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof adminClientsGetClient>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  getAdminClientsGetClientQueryKey(clientId);
   ...
   return  { queryKey, queryFn, enabled: computed(() => !!(unref(clientId))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminClientsGetClient>>, TError, TData> 
}
...
export function useAdminClientsGetClient<TData = Awaited<ReturnType<typeof adminClientsGetClient>>, TError = AxiosError<ErrorResponse>>(
 clientId: MaybeRef<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof adminClientsGetClient>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
...
export const adminClientsUpdateClient = (
    ...
    updateOAuthClientRequest: MaybeRef<UpdateOAuthClientRequest>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<OAuthClient>> => {
    clientId = unref(clientId);
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationReturnType<
    ...
    clientId: MaybeRef<string>,
    adminClientsSetClientStatusBody: MaybeRef<AdminClientsSetClientStatusBody>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<OAuthClient>> => {
    clientId = unref(clientId);
