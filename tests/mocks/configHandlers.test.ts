...
describe('mocks/handlers.ts (ch41-42) — loginSecurity/passwordPolicy/riskControl/notification/openPlatform', () => {
  it('GET /login-security 单例', async () => {
  ...
  it('PUT /login-security 更新', async () => {
  ...
  it('GET /notification-config 单例', async () => {
  ...
  it('PUT /notification-config 更新', async () => {
