...
describe('mocks/handlers.ts (ch42) — positions/userGroups/permissionGroups', () => {
  it('GET /positions 默认 5 个岗位', async () => {
  ...
  it('PUT /permission-groups/:id 更新 permissions', async () => {
  ...
  it('DELETE /permission-groups/:id 204', async () => {
